    ...
    <section className="bg-[#0a0a0a] py-16 md:py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          {/* Explore CTA */}
          <button className="flex items-center gap-2 px-7 py-2.5 rounded-full border border-[#c9a96e]/30 text-[#c9a96e] text-[11px] tracking-[0.2em] uppercase font-medium hover:bg-[#c9a96e]/10 hover:border-[#c9a96e]/50 transition-all duration-300">
            Explore Privé
