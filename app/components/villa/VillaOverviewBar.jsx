...
export default function VillaOverviewBar({ guests, eventCapacity, bedrooms, bathrooms, area, highlights = [] }) {
  const items = [
    {
      label: 'Stay Guests',
      value: guests,
      ...
      <div className="flex items-center gap-6 md:gap-8 overflow-x-auto scrollbar-hide">
        ...
        <div className="flex items-center gap-4 pr-4">
          {highlights.slice(0, 4).map((tag, i) => (
            <span key={i} className="inline-flex items-center gap-1.5 flex-shrink-0 text-[11px] tracking-wider text-[#072720]/50 font-medium whitespace-nowrap">
