        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div>
            ...
            <div className="space-y-3.5">
              ...
              <a
                href="#"
                className="inline-flex items-center gap-2 mt-2 px-5 py-2 rounded-full border border-green-500/30 bg-green-500/10 text-green-400 text-xs tracking-wider font-medium hover:bg-green-500/20 hover:border-green-500/50 hover:shadow-[0_0_15px_rgba(34,197,94,0.15)] transition-all duration-300"
              >
